...
int main( int argc, char** argv ){
	...
	double center_line;
	center_line = abs(center_buoy_x - center_buoy_x_r)/2;
	cout << "######## Posisi Tengah #########" << endl;
	cout << "Posisi X  : " << center_buoy_x << endl;
	cout << "Posisi X_R : " << center_buoy_x_r << endl;
	cout << "Center Buoy : " << center_line+ center_buoy_x_r << endl;

	Point2f circle_center_line;
	circle_center_line.x = center_line + center_buoy_x_r;
	circle_center_line.y = center_buoy_y_r;
	circle( imageResult, circle_center_line, radius_buoy_r, color, 4, 8, 0 );
